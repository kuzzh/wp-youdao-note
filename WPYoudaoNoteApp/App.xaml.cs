...
using WPYoudaoNoteApp.Resources;
...
namespace WPYoudaoNoteApp
{
    public partial class App : Application
    {
        ...
        {
            LoggerFactory.GetLogger().Error("应用程序发生无法处理的导航异常", e.Exception);
        ...
        {
            LoggerFactory.GetLogger().Error("应用程序发生无法处理的异常", e.ExceptionObject);
        ...
        private void InitializePhoneApplication()
        {
           ...
           // RootFrame = new PhoneApplicationFrame();
            ...
            {
                ImageSource = new System.Windows.Media.Imaging.BitmapImage(new Uri("Assets/background.jpg", UriKind.Relative)),
                Opacity = 0.8d
            };
